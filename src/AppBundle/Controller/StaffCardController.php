...
class StaffCardController extends Controller
{
    ...
    public function searchAction(Request $request)
    {
        ...
        if ($request->isMethod('POST')){
            ...
            if ($card){
                return $this->redirectToRoute('staff_card_view', [
        ...
        return $this->render('staff/card/search.html.twig', array(
    ...
    public function cardViewAction(Card $card)
    {
        ...
        return $this->render('staff/card/card.html.twig',[
    ...
    public function editCardAction(Request $request, Card $card)
    {
        ...
        return $this->render('staff/card/edit_card.html.twig', array(
            "form" => $form->createView()
        ));
    }
    ...
    public function editCustomerAction(Request $request, Card $card)
    {
        ...
        return $this->render('staff/card/edit_customer.html.twig', array(
            "form" => $form->createView()
        ));
    }
